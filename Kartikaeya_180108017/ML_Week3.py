...
import utils
#================================== Storing Data ======================================
data = np.array(np.loadtxt('C:/Users/Kartikaeya/Desktop/ex2data1.txt',delimiter=','))
X,y = data[:,(0,1)],data[:,2]
...
def CostFunction(theta, X, y):
    ...
    for i in range(0,3):
        ...
        grad[i]=a/m
    return Cost,grad
#========================== testing CostFunction and Gradient===========================
...
#===================================== Load Data =========================================
data = np.array(np.loadtxt('C:/Users/Kartikaeya/Desktop/ex2data2.txt', delimiter=','))
X = data[:, :2]
y = data[:, 2]
#====================================== Plot Data ========================================
plotData(X, y)
